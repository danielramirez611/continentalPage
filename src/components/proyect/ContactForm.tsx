...
const ContactForm = () => {
  ...
  // Usamos useInView para detectar cuándo la sección está visible
      ...
      <div className="container mx-auto px-4 relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <motion.h3
              initial="hidden"
              animate={isSectionVisible ? "visible" : "hidden"} // Animación basada en la visibilidad
            ...
            <motion.p
              ...
              animate={isSectionVisible ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }} // Animación basada en la visibilidad
